...
This repo was forked from [Maxime GRIS](https://github.com/maximegris/angular-electron).

Bootstrap and package your project with Angular 4(+) and Electron (Typescript + SASS + Hot Reload) for creating desktop applications. This desktop app is very simple and will quickly calculate your take home pay.
